...
function DetailBox() {
  ...
  const filteredTodo = data.find(item => item.id === params.id)
    ...
    <StyledDiv>
      ...
      <StyledTable>
        ...
        <tr>
          ...
          <StyledTh>{filteredTodo?.id}</StyledTh>
        </tr>
        <tr>
          <StyledTh>TITLE</StyledTh>
          <StyledTh>{filteredTodo?.title}</StyledTh>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <StyledTh>{filteredTodo?.isDone ? "완료" : "미완료"}</StyledTh>
        </tr>
      </StyledTable>
